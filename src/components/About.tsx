...
export const About = () => {
  return (
    <section id="about" class="lg:w-2/3  mx-auto bg-neutral-800   md:mb-10">
      <Container class="h-auto  mx-auto  p-3  ">
        ...
        <div class="grid p-4 mx-auto  items-center justify-items-center md:grid-cols-4  gap-4 ">
          <div class="w-2/3  h-full flex justify-center md:w-full md:col-span-1 lg:h-[40rem]">
            <img src="/profile.jpeg" class=" my-auto  md:max-h-full object-contain rounded-lg" />
          </div>
          <div class=" ml-4 mb-4 w-5/6 text-base md:text-lg md:col-span-3   md:text-left">
