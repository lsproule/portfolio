  ...
  return (<section id="contact" class=" h-full p-3 ">
    <Container class="h-full ">
      ...
      <div class="flex mb-4 flex-col mt-48 gap-4 items-center  justify-center text-xl font-bold  text-green-500">
        ...
        <input type="text" class="border inline-block align-text-top bg-primary  text-green-500  border-green-500 rounded-xl  pt-2 pb-20 px-2  ml-2" placeholder="message" />
